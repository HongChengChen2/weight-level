...
def main():
    ...
    if args.resume:
        ...
        re_path1 = os.path.join(args.resume, 'data1/scratch4c_2.pth.tar')
        re_path2 = os.path.join(args.resume, 'data2/scratch4c_2.pth.tar')
        re_path3 = os.path.join(args.resume, 'data3/scratch4c_2.pth.tar')
